...
public class SuscribirseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_suscribirse, container, false);
    ...
    public class BackgroundWorker extends AsyncTask<String,Void,String> {
        ...
        SuscribirseFragment context;
        AlertDialog alertDialog;
        BackgroundWorker(SuscribirseFragment ctx)
        {
            context=ctx;
        }
        @Override
        protected String doInBackground(String... params) {
            ...
            if(type.equals("registro"))
            {
                try{
                    ...
                    String ide=params[2];
                    String ciud=params[3];
                    String barri=params[4];
                    String direc1=params[5];
                    String telefo=params[6];
                    String electronico=params[7];
                    ...
                    String post_data= URLEncoder.encode("nombre","UTF-8")+"="+URLEncoder.encode(nombr,"UTF-8")+"&"
                            +URLEncoder.encode("identificacion","UTF-8")+"="+URLEncoder.encode(ide,"UTF-8")+"&"
                            + URLEncoder.encode("ciudad","UTF-8")+"="+URLEncoder.encode(ciud,"UTF-8")+"&"
                            + URLEncoder.encode("barrio","UTF-8")+"="+URLEncoder.encode(barri,"UTF-8")
                             +URLEncoder.encode("direccion","UTF-8")+"="+URLEncoder.encode(direc1,"UTF-8")+"&"
                            + URLEncoder.encode("telefono","UTF-8")+"="+URLEncoder.encode(telefo,"UTF-8")+"&"
                            + URLEncoder.encode("correo","UTF-8")+"="+URLEncoder.encode(electronico,"UTF-8");
