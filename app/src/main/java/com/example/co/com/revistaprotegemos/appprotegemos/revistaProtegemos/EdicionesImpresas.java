...
public class EdicionesImpresas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url="http://192.168.0.17/fotos/Edicion1.png";
        Glide.with(this)
                .load(url)
                .centerCrop()
                .crossFade()
        ...
        String url2="http://192.168.0.17/fotos/Edicion2.png";
        Glide.with(this)
                .load(url2)
                .centerCrop()
                .crossFade()
        ...
        String url3="http://192.168.0.17/fotos/Edicion3.png";
        Glide.with(this)
                .load(url3)
                .centerCrop()
                .crossFade()
        ...
        String url4="http://192.168.0.17/fotos/Edicion4.png";
        Glide.with(this)
                .load(url4)
                .centerCrop()
                .crossFade()
        ...
        String url5="http://192.168.0.17/fotos/Edicion5.png";
        Glide.with(this)
                .load(url5)
                .centerCrop()
                .crossFade()
        ...
        String url6="http://192.168.0.17/fotos/Edicion6.png";
        Glide.with(this)
                .load(url6)
                .centerCrop()
                .crossFade()
        ...
        String url7="http://192.168.0.17/fotos/Edicion7.png";
        Glide.with(this)
                .load(url7)
                .centerCrop()
                .crossFade()
        ...
        String url8="http://192.168.0.17/fotos/Edicion8.png";
        Glide.with(this)
                .load(url8)
                .centerCrop()
                .crossFade()
        ...
        String url9="http://192.168.0.17/fotos/Edicion9.png";
        Glide.with(this)
                .load(url9)
                .centerCrop()
                .crossFade()
        ...
        String url10="http://192.168.0.17/fotos/Edicion10.png";
        Glide.with(this)
                .load(url10)
                .centerCrop()
                .crossFade()
        ...
        String url11="http://192.168.0.17/fotos/Edicion11.png";
        Glide.with(this)
                .load(url11)
                .centerCrop()
                .crossFade()
        ...
        String url12="http://192.168.0.17/fotos/Edicion12.png";
        Glide.with(this)
                .load(url12)
                .centerCrop()
                .crossFade()
        ...
        String url13="http://192.168.0.17/fotos/Edicion13.png";
        Glide.with(this)
                .load(url13)
                .centerCrop()
                .crossFade()
        ...
        String url14="http://192.168.0.17/fotos/Edicion14.png";
        Glide.with(this)
                .load(url14)
                .centerCrop()
                .crossFade()
